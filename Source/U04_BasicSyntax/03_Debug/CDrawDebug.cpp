...
ACDrawDebug::ACDrawDebug()
{
	...
	RelativeLocation[0] = { 0, 0, 0 };
	RelativeLocation[1] = { 0, 500, 0 };
	RelativeLocation[2] = { -500, 0, 0 };
	RelativeLocation[3] = { -1000, 0, 0 };
...
void ACDrawDebug::Tick(float DeltaTime)
{
	...
	sphereLocation.X += FMath::Sin(GetWorld()->GetTimeSeconds() * 3.f) * 200;
